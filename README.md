...
The current release contains 1,102 direct videos across six research directions.

| Direction | Scope | Resources |
| --- | --- | ---: |
| World Models | Learned simulators, temporal dynamics, planning, spatial reasoning, and video world models | 86 |
...
| Robotics | Robot learning, control, manipulation, embodied intelligence, and grounded action | 200 |
| Broader AI | Foundations, AI systems, NLP, industry, social impact, and research frontiers | 456 |
| How to Research | Problem finding, literature review, experimental design, evaluation, writing, peer review, and research communication | 32 |
